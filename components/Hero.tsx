    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-4 pt-24 pb-8">
      ...
      >
        ...
        <motion.p
          ...
          className="text-lg sm:text-xl text-[#a3a3a3] max-w-2xl mx-auto mb-4"
        >
          The Cebu community for AI-powered developers
        </motion.p>
        ...
        >
          <a
            ...
            className="flex items-center gap-2 bg-white text-black px-6 py-3 rounded-full font-medium hover:bg-[#e5e5e5] transition-all hover:scale-105"
          >
        ...
        >
          <div>
            ...
            <div className="text-sm text-[#737373] mt-1">Community Members</div>
          </div>
          <div>
            <div className="text-3xl sm:text-4xl font-bold font-mono">10+</div>
            <div className="text-sm text-[#737373] mt-1">Events Held</div>
          </div>
          <div>
            <div className="text-3xl sm:text-4xl font-bold font-mono">5+</div>
            <div className="text-sm text-[#737373] mt-1">Workshops</div>
          </div>
        </motion.div>
      </motion.div>
