      ...
      >
        ...
        >
          <a
            ...
            className="group relative flex items-center gap-2 bg-white text-black px-8 py-4 rounded-full font-medium overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(124,58,237,0.4)]"
          >
            ...
            <svg className="w-5 h-5 relative z-10 group-hover:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a
            href="#events"
            className="group flex items-center gap-2 border border-[#333] text-white px-8 py-4 rounded-full font-medium transition-all duration-300 hover:border-purple-500/50 hover:bg-purple-500/10 hover:scale-105"
          >
            <svg
