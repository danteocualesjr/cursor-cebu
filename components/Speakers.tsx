      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          {filteredSpeakers.map((speaker, index) => (
            <motion.div
              ...
              className="group relative bg-[#111]/80 backdrop-blur-sm border border-white/5 rounded-2xl p-8 text-center transition-all duration-500 hover:border-purple-500/30 hover:shadow-[0_20px_60px_-15px_rgba(124,58,237,0.2)]"
            >
              {/* Decorative gradient */}
                ...
                <div className="flex justify-center gap-3 mt-6 pt-6 border-t border-white/5">
                  {speaker.linkedinUrl && (
                    <a
                      ...
                      className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-[#737373] hover:text-white hover:bg-[#0077B5]/20 transition-all duration-300"
                    >
                  ...
                  {speaker.twitterUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-[#737373] hover:text-white hover:bg-white/10 transition-all duration-300"
                    >
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <a
              href="#contact"
              className="group inline-flex items-center gap-2 bg-white text-black px-8 py-4 rounded-full font-medium overflow-hidden transition-all duration-300 hover:shadow-[0_0_40px_rgba(124,58,237,0.4)]"
            >
